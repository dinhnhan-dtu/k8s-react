...
kubectl set image deployment/client-deployment server=atdinhnhan/multi-client:$SHA
kubectl set image deployment/worker-deployment server=atdinhnhan/multi-worker:$SHA